...
class _LarkMixinProtocol(Protocol):
    ...
    async def delete_file(self, file_token: str, file_type: str) -> dict[str, Any]: ...
    async def check_task(self, task_id: str) -> dict[str, Any]: ...
    async def create_folder(self, name: str, folder_token: str) -> dict[str, Any]: ...
    ...
    async def create_spreadsheet(
        self, title: str, *, folder_token: str | None = ...
    ) -> dict[str, Any]: ...
    async def get_spreadsheet(self, spreadsheet_token: str) -> dict[str, Any]: ...
    async def query_sheets(self, spreadsheet_token: str) -> dict[str, Any]: ...
